...
CREATE TABLE `order_workflow` (
  ...
  CONSTRAINT `order_workflow_ibfk_1` FOREIGN KEY (`OrderID`) REFERENCES `orders` (`ID`),
  CONSTRAINT `order_workflow_ibfk_2` FOREIGN KEY (`WorkflowID`) REFERENCES `workflows` (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `order_workflow` WRITE;
/*!40000 ALTER TABLE `order_workflow` DISABLE KEYS */;
INSERT INTO `order_workflow` VALUES (1,1,1,1);
/*!40000 ALTER TABLE `order_workflow` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `order_workflow_flow` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `OrderWorkflowID` int NOT NULL,
  `WorkflowFlowID` int NOT NULL,
  `status` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `OrderWorkflowID` (`OrderWorkflowID`),
  KEY `WorkflowFlowID` (`WorkflowFlowID`),
  CONSTRAINT `order_workflow_flow_ibfk_1` FOREIGN KEY (`OrderWorkflowID`) REFERENCES `order_workflow` (`ID`),
...
INSERT INTO `order_workflow_flow` VALUES (1,1,1,1);
...
INSERT INTO `order_workflow_flow_steps` VALUES (1,1);
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`InventoryID`) REFERENCES `inventory` (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `orders` VALUES (1,'2022-08-21 20:46:15',11,'Test Order','123, Test address','2022-08-22 20:46:15',NULL);
...
INSERT INTO `storage_locations` VALUES (1,'Test','23424','4234');
...
INSERT INTO `workflow_flows` VALUES (1,1,1,'1');
...
INSERT INTO `workflows` VALUES (1,'First Workflow',1);
...
-- Dump completed on 2022-08-23 17:10:38
